...
const name = 'norris-joke'
const baseRoute = '/norris-joke'

console.log('norris duck sees norris service as',norrisService.types)
...
/** Selectors */
/*Dunno nothing about selectors - leaving them as they were in jokes-duck, changing only imports
* and deleting selectors for unused state fields*/
